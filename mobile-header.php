...
<header class="site__mobile-header">
			<div class="mobile-header">
				<div class="container">
					<div class="mobile-header__body"><button style="fill:#e52727;" class="mobile-header__menu-button" type="button"><svg
								width="18px" height="14px">
								<path
									d="M-0,8L-0,6L18,6L18,8L-0,8ZM-0,-0L18,-0L18,2L-0,2L-0,-0ZM14,14L-0,14L-0,12L14,12L14,14Z" />
								</svg></button> <a class="mobile-header__logo" href="home">
                            <!-- mobile-logo --> 	<img style="margin-left:20px;height:50px;" src="images/blaise.jpeg" alt="Site logo"><!-- mobile-logo / end --></a>
                            <?php //if($hidesearch==''){ ?>
						<div class="mobile-header__search mobile-search">
                       
							<form class="mobile-search__body" action="shop-list" method="GET">
                            <input class="mobile-search__input" type="text" name="search" value="<?php if(isset($_GET['search']))echo $_GET['search']; ?>"
	...
	c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C13,5.2,10.8,3,8,3z" /></svg></button> <button type="submit"
    name="searchsubmit" class="mobile-search__button mobile-search__button--close"><svg width="20"
										height="20">
	...
	c0,2.8,2.2,5,5,5c2.8,0,5-2.2,5-5C13,5.2,10.8,3,8,3z" /></svg></span></button></div>
							<div class="mobile-indicator d-none d-md-block"><a href="account-login"
									class="mobile-indicator__button"><span class="mobile-indicator__icon"><svg
											width="20" height="20">
	...
	c0,1.9-0.9,3.6-2.3,4.7C17.4,12.2,20,15.8,20,20z M14,6c0-2.2-1.8-4-4-4S6,3.8,6,6s1.8,4,4,4S14,8.2,14,6z" />
							...
							<div class="mobile-indicator d-none d-md-block"><a href="wishlist"
									class="mobile-indicator__button"><span class="mobile-indicator__icon">
                                        <svg
											width="20" height="20">
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z" /></svg> <span
											class="mobile-indicator__counter ball">0</span></span></a></div>
						</div>
					</div>
				</div>
			</div>
